...
namespace HIS.Model
{
    ...
    public partial class Sys_Dic : Entity
    {
		...
		public long CatalogId
		{
			...
			set
			{
				this.OnPropertyValueChange("CatalogId");
		...
		public bool IsBuiltIn
		{
			...
			set
			{
				this.OnPropertyValueChange("IsBuiltIn");
        ...
        public class _
        {
			...
			/// 
			/// </summary>
			public readonly static Field Id = new Field("Id", "Sys_Dic", "");
            /// <summary>
			/// 医疗机构ID
			/// </summary>
			public readonly static Field HosId = new Field("HosId", "Sys_Dic", "医疗机构ID");
            /// <summary>
			/// 目录ID
			/// </summary>
			public readonly static Field CatalogId = new Field("CatalogId", "Sys_Dic", "目录ID");
            /// <summary>
			/// 代码
			/// </summary>
			...
			/// 是否内置 0否 1是
			/// </summary>
			public readonly static Field IsBuiltIn = new Field("IsBuiltIn", "Sys_Dic", "是否内置 0否 1是");
            /// <summary>
			/// 描述
			/// </summary>
			...
			/// 当前用户ID
			/// </summary>
			public readonly static Field CreatorUserId = new Field("CreatorUserId", "Sys_Dic", "当前用户ID");
            /// <summary>
			/// 创建时间
			/// </summary>
			public readonly static Field CreationTime = new Field("CreationTime", "Sys_Dic", "创建时间");
            /// <summary>
			/// 删除用户ID
			/// </summary>
			public readonly static Field DeleterUserId = new Field("DeleterUserId", "Sys_Dic", "删除用户ID");
            /// <summary>
			/// 删除时间
			/// </summary>
			public readonly static Field DeletionTime = new Field("DeletionTime", "Sys_Dic", "删除时间");
            /// <summary>
			/// 最后修改用户ID
			/// </summary>
			public readonly static Field LastModifierUserId = new Field("LastModifierUserId", "Sys_Dic", "最后修改用户ID");
            /// <summary>
			/// 最后修改时间
			/// </summary>
			public readonly static Field LastModificationTime = new Field("LastModificationTime", "Sys_Dic", "最后修改时间");
            /// <summary>
			/// 状态 0 停用 1启用 2作废
			/// </summary>
			public readonly static Field DataStatus = new Field("DataStatus", "Sys_Dic", "状态 0 停用 1启用 2作废");
            /// <summary>
			/// 
			/// </summary>
			public readonly static Field No = new Field("No", "Sys_Dic", "");
        }
        #endregion
	}
}