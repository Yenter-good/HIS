...
{
    public partial class FormInspectionManager : BaseForm
    {
        ...
        private int currAdviceGridIndex = -1;
        public FormInspectionManager(IAdviceService adviceService, IFeeItemService feeService)
        {
            InitializeComponent();
        ...
        {
            return _adviceService.GetAllByType(AdviceType.检验);
        }
        //查询医嘱包含明细
