...
namespace HIS.Service.Core
{
    ...
    /// 用户参数服务
    /// </summary>
    public interface IUserParameterService : IServiceSingleton
    {
        /// <summary>
        /// 获取指定名称的参数值
        /// </summary>
        ...
        /// </summary>
        /// <returns></returns>
        DataResult<List<UserParameterEntity>> GetAll();
        /// <summary>
        /// 判断是否存在指定参数
        /// </summary>
        /// <param name="code"></param>
        ...
        /// <returns></returns>
        DataResult Update(UserParameterEntity sysParameterEntity);
    }
}
