...
{
    public interface  IPharmacyTakeStockService : IServiceSingleton
    {
        //获取盘点单列表
        ...
        /// <returns></returns>
        DataResult<TakeStockDetailEntity> UpdateDetailQuantity(long entityId, int bigQuantity,int smallQuantity);
    }
}
